...
$(document).ready(function () {
    var body = $('body');
    var globalNav = body.children('header-navigation');
    var globalSideMenu = body.children('div.sidemenu');

    globalNav.find('.hamburger').on('click', function () {
        globalSideMenu.toggleClass('visible');
    });

    globalSideMenu.find('.toggle').on('click', function () {
        globalSideMenu.toggleClass('visible');
    });
    $('body > nav .sub-nav-container > a, body > div.sidemenu .sub-nav-container > a').on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    $(window).on('click', function () {
        ...
        $('.sidemenu .sidemenu-navigation.visible').removeClass('visible');
    });
